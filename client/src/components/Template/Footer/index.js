        ...
        <div className="container">
          <div className="footer-grids">
            ...
            >
              <h3>Giới thiệu</h3>
              <p>
                Houseware Store chuyên cung cấp các sản phẩm đồ gia dụng giá rẻ,
                chất lượng cao.
                <span>
                  Nhiều chính sách khuyến mãi, 1 đổi 1 trong vòng 7 ngày và bảo
                  hành trọn đời cho mọi sản phẩm.
                </span>
              </p>
            </div>
            <div
